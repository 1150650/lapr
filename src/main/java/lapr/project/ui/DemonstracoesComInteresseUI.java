 ...
 * @author Simão Pedro
 */
public class DemonstracoesComInteresseUI extends JFrame {
    ...
    public DemonstracoesComInteresseUI(CriarCandidaturaExposicaoUI framePai, CriarCandidaturaExposicaoController crt) {
        this.crt = crt;
